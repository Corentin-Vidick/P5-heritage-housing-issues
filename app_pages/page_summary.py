...
def page_summary():
    ...
    st.info(
        f"**Project Dataset**\n"
        f"*- This project uses a dataset sourced from [Kaggle]\
        (https: // www.kaggle.com/codeinstitute/housing-prices-data).\
        - The first part of the dataset, house_price_records, has 1460 rows\
         and 24 columns. 23 of them represent the house profile from\
         properties in Ames, Iowa, built between 1872 and 2010\
         (i.e: Floor Area, Basement, Garage, Kitchen, Lot, Porch, Wood Deck,\
         Year Built). The last column represents the sale price for the\
         property, this will be our target variable."
    )
    ...
    st.write(
        ...
        (https://github.com/Corentin-Vidick/P5-heritage-housing-issues/blob/main/README.md).")
