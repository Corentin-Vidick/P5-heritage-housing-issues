...
def page_hypothesis():
    ...
    st.success(
        ...
        f"The size of the house is positively correlated to the sale price.\
            We can see this through the features 1stFlrSF, GarageArea, GrLivArea, LotFrontage and TotalBsmtSF.\n\n"
        f"**Hypothesis two:**\t"
        f"The quality/condition of the property is positively correlated to the sale price.\
            Features such as BsmtFinType1, GarageFinish, KitchenQual or OverallQual confirm this.\n\n"
        f"**Hypothesis three:**\t"
